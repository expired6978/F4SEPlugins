...
RelocPtr<UInt32> g_faceGenTextureWidth(0x02F4D950); // "FaceCustomization"  //AddressLibrary index 2666739
RelocPtr<UInt32> g_faceGenTextureHeight(0x02F4D954); // AddressLibrary index 2666740
...
__declspec(dllexport) F4SEPluginVersionData F4SEPlugin_Version =
{
	...
	{ RUNTIME_VERSION_1_11_240, 0 },	// compatible with 1.11.240
...
__declspec(dllexport) bool F4SEPlugin_Preload(const F4SEInterface * f4se)
{
	...
	else if(f4se->runtimeVersion != RUNTIME_VERSION_1_11_240)
	{
		UInt32 runtimeVersion = RUNTIME_VERSION_1_11_240;
		char buf[512];
